...
model_urls = {
    'resnet18': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnet18.pkl',
    'resnet34': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnet34.pkl',
    'resnet50': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnet50.pkl',
    'resnet101': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnet101.pkl',
    'resnet152': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnet152.pkl',
    'resnext50_32x4d': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnext50_32x4d.pkl',
    'resnext101_32x8d': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnext101_32x8d.pkl',
    'wide_resnet50_2': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/wide_resnet50_2.pkl',
    'wide_resnet101_2': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/wide_resnet101_2.pkl',
    'seresnet18': '',
    'seresnet34': '',
    'seresnet50': '',
    'seresnet101': '',
    ...
    'seresnext50_32x4d': '',
    'seresnext101_32x8d': '',
    'resnest14': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnest14.pkl',
    'resnest26': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnest26.pkl',
    'resnest50': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnest50.pkl',
    'resnest101': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnest101.pkl',
    'resnest200': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnest200.pkl',
    'resnest269': 'https://github.com/Qsingle/Megvision/releases/download/v1.0/resnest269.pkl'
}
...
class Bottleneck(M.Module):
    ...
    def __init__(self, inplanes, outplanes, stride=1, dilation=1, groups=1, downsample=None,
        ...
        if self.radix > 1:
            self.conv2 = SplAtConv2d(width, width, ksize=3, stride=stride, padding=dilation,
                                     dilation=dilation, groups=groups, radix=radix, reduction_factor=reduction,
...
def _resnet(arch, block, blocks, pretrained=False, **kwargs):
    '''
...
def resnet18(pretrained=False,  **kwargs):
    ...
    return _resnet("resnet18", BasicBlock, get_layers(18), pretrained,  **kwargs)
...
def resnet34(pretrained=False,  **kwargs):
    ...
    """
    return _resnet("resnet34", BasicBlock, get_layers(34), pretrained,  **kwargs)
...
def resnet50(pretrained=False,  **kwargs):
    ...
    return _resnet("resnet50", Bottleneck, get_layers(50), pretrained,  **kwargs)
...
def resnet101(pretrained=False,  **kwargs):
    ...
    """
    return _resnet("resnet101", Bottleneck, get_layers(101), pretrained,  **kwargs)
...
def resnet152(pretrained=False,  **kwargs):
    ...
    return _resnet("resnet152", Bottleneck, get_layers(152), pretrained,  **kwargs)
...
def resnext50_32x4d(pretrained=False,  **kwargs):
    ...
    kwargs["radix"] = 0
    return _resnet("resnext50_32x4d", Bottleneck, get_layers(50), pretrained,  **kwargs)
...
def resnext101_32x8d(pretrained=False, **kwargs):
    ...
    return _resnet("resnext101_32x8d", Bottleneck, get_layers(101), pretrained, **kwargs)
...
def wide_resnet50_2(pretrained=False,  **kwargs):
    ...
    return _resnet("wide_resnet_50_2", Bottleneck, get_layers(50), pretrained,  **kwargs)
...
def wide_resnet101_2(pretrained=False,  **kwargs):
    ...
    """
    kwargs["width_per_group"] = 64 * 2
    return _resnet("wide_resnet_101_2", Bottleneck, get_layers(101), pretrained,  **kwargs)
...
def seresnet18(pretrained=False,  **kwargs):
    ...
    return _resnet("seresnet18", BasicBlock, get_layers(18), pretrained,  **kwargs)
...
def seresnet34(pretrained=False,  **kwargs):
    ...
    """
    kwargs["se_module"] = SEModule
    return _resnet("seresnet34", BasicBlock, get_layers(34), pretrained,  **kwargs)
...
def seresnet50(pretrained=False,  **kwargs):
    ...
    """
    kwargs["se_module"] = SEModule
    return _resnet("seresnet50", Bottleneck, get_layers(50), pretrained,  **kwargs)
...
def seresnet101(pretrained=False,  **kwargs):
    ...
    """
    kwargs["se_module"] = SEModule
    return _resnet("seresnet101", Bottleneck, get_layers(101), pretrained,  **kwargs)
...
def seresnet152(pretrained=False,  **kwargs):
    ...
    """
    kwargs["se_module"] = SEModule
    return _resnet("seresnet152", Bottleneck, get_layers(152), pretrained,  **kwargs)
...
def seresnext50_32x4d(pretrained=False,  **kwargs):
    ...
    kwargs["width_per_group"] = 4
    kwargs["se_module"] = SEModule
    return _resnet("seresnext50_32x4d", Bottleneck, get_layers(50), pretrained,  **kwargs)
...
def seresnext101_32x8d(pretrained=False,  **kwargs):
    ...
    kwargs["width_per_group"] = 8
    kwargs["se_module"] = SEModule
    return _resnet("seresnext101_32x8d", Bottleneck, get_layers(101), pretrained,  **kwargs)

@BACKBONE_REGISTER.register()
def resnest14(pretrained=False,  **kwargs):
    r"""
    ...
    return _resnet("resnest14", Bottleneck, get_layers(14), pretrained,  **kwargs)

@BACKBONE_REGISTER.register()
def resnest26(pretrained=False,  **kwargs):
    r"""
    ...
    kwargs["reduction"] = 4
    kwargs["stem_width"] = 32
    return _resnet("resnest26", Bottleneck, get_layers(26), pretrained,  **kwargs)
...
def resnest50(pretrained=False,  **kwargs):
    ...
    kwargs["stem_width"] = 32
    kwargs["reduction"] = 4
    return _resnet("resnest50", Bottleneck, get_layers(50), pretrained,  **kwargs)
...
def resnest101(pretrained=False,  **kwargs):
    ...
    kwargs["light_head"] = True
    kwargs["reduction"] = 4
    return _resnet("resnest101", Bottleneck, get_layers(101), pretrained,  **kwargs)
...
def resnest200(pretrained=False,  **kwargs):
    ...
    kwargs["light_head"] = True
    kwargs["reduction"] = 4
    return _resnet("resnest200", Bottleneck, get_layers(200), pretrained,  **kwargs)
...
def resnest269(pretrained=False,  **kwargs):
    ...
    kwargs["light_head"] = True
    kwargs["reduction"] = 4
    return _resnet("resnest269", Bottleneck, get_layers(269), pretrained,  **kwargs)
