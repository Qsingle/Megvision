...
def get_inception_v3(**kwargs):
    return Inception3(**kwargs)


class Inception3(M.Module):

    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False,
                 inception_blocks=None, in_chs=3):
        ...
        self.Conv2d_1a_3x3 = conv_block(in_chs, 32, kernel_size=3, stride=2)
...
class InceptionE(M.Module):
    ...
    def forward(self, x):
        ...
        branch3x3 = F.concat(branch3x3, 1)
        ...
        branch3x3dbl = F.concat(branch3x3dbl, 1)
